...
import { confirmable, ConfirmDialog, ContextAwareConfirmation, createConfirmation } from 'react-confirm';
    ...
    {(theme) => (
      <div className="static-modal">
        <Modal animation={false} show={props.show} onHide={() => props.proceed(false)} backdrop={true}>
          <Modal.Header>
            <Modal.Title>{props.title}(theme: {theme})</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            {props.confirmation}
          </Modal.Body>
...
export default ContextAwareConfirmation.createConfirmation(confirmable(Confirmation));
